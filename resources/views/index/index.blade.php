					...
					<div class="all-sort-list2">
						...
						<div class="item bo">
							...
							<div class="item-list clearfix">
								<div class="subitem">
									@foreach($cat[$k]['cat2'] as $e=>$c)
									<dl class="fore{{$e+1}}">
										<dt><a href="">{{$c->cat_name}}</a></dt>
										<dd>
											@foreach($cat[$k]['cat2'][$e]['cat3'] as $l)
											<em><a href="">{{$l->cat_name}}</a></em>
											@endforeach
										</dd>
									</dl>
									@endforeach
			...
			<div class="bd">
				...
				<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="{{route('goods_content',['id'=>$v['id'],'skuid'=>$v['sku']['id']])}}" class="pic"><img src="{{Storage::url($v->logo)}}" alt="" /></a>
								<div class="like-text">
									<p>{{$v->goods_name}}</p>
									<h3>¥{{$v->price}}</h3>
								</div>
