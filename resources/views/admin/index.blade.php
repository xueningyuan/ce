			...
			<div class="sidebar" id="sidebar">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home">
							<a href="javascript:void(0)" name="{{ route('admin_home') }}" class="iframeurl" title="">
								<i class="icon-home"></i>
						...
						<li>
							...
							<ul class="submenu">
								<li class="home">
									<a href="javascript:void(0)" name="{{ route('goods') }}" title="商品列表" class="iframeurl">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li class="home">
									<a href="javascript:void(0)" name="{{ route('admin_info') }}" title="个人信息" class="iframeurl">
