					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<ul>
								...
								<li style="text-align: center">{{ $e}}</li>
								@endforeach
							</ul>
							@endif
								...
								<fieldset>
									<ul>
										<li class="frame_style form_error">
											...
											<input name="admin_name" type="text" id="username" />
											<i>用户名</i>
										</li>
										<li class="frame_style form_error">
										...
										<li class="frame_style form_error">
											...
											<input name="captcha" type="text" id="Codes_text" />
											<i>验证码</i>
											<div class="Codes_region"><img style="width: 80px;height: 38px;" onclick="this.src='{{ route('captcha')}}?'+Math.random()" src="{{route('captcha')}}" alt=""></div>
										</li>
